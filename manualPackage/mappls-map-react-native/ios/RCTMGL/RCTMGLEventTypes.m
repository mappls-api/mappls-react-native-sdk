...
NSString *const RCT_MAPPLS_MAP_REINIT = @"onmapreinit";
NSString *const RCT_MAPPLS_STYLES_LIST_LOADED = @"didloadedmapplsmapsstyles";
...
NSString *const RCT_MAPBOX_GEOANALYTICS_LAYER_PRESS = @"geoanalyticslayerpress";

NSString *const RCT_MAPBOX_IMAGES_MISSING_IMAGE = @"imagesmissingimage";

NSString *const RCT_MAPBOX_HIDE_INDOOR_CONTROL = @"hidecontrolindoor";
NSString *const RCT_MAPBOX_SHOW_INDOOR_CONTROL = @"showcontrolindoor";
