...
extern NSString *const RCT_MAPPLS_EVENT_MAP_ERROR;
...
extern NSString *const RCT_MAPPLS_MAP_REINIT;
extern NSString *const RCT_MAPPLS_STYLES_LIST_LOADED;
...
extern NSString *const RCT_MAPBOX_GEOANALYTICS_LAYER_PRESS;

extern NSString *const RCT_MAPBOX_USER_LOCATION_UPDATE;

extern NSString *const RCT_MAPBOX_HIDE_INDOOR_CONTROL;
extern NSString *const RCT_MAPBOX_SHOW_INDOOR_CONTROL;
