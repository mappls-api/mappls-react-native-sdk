...
- (void) addToMap:(id<RCTComponent>)subview
{
    ...
    else if ([subview isKindOfClass:[RCTMGLGeoAnalytics class]]) {
        RCTMGLGeoAnalytics *geoAnalytics = (RCTMGLGeoAnalytics *)subview;
        _geoanalytics = geoAnalytics;
        if (_reactEnableGeoAnalyticsInfoWindow) {
            [_geoanalyticsPlugin setShouldShowPopupForGeoanalyticsLayer:_reactEnableGeoAnalyticsInfoWindow];
        }
        geoAnalytics.map = self;
...
-(void)setReactEnableTraffic:(BOOL)reactEnableTraffic {
    _reactEnableTraffic = reactEnableTraffic;
    self.trafficEnabled = _reactEnableTraffic;
}


-(void)setReactEnableTrafficStopIcon:(BOOL)reactEnableTrafficStopIcon {
    _reactEnableTrafficStopIcon = reactEnableTrafficStopIcon;
    self.stopIconTrafficEnabled = _reactEnableTrafficStopIcon;
}

-(void)setReactEnableTrafficNonFreeFlow:(BOOL)reactEnableTrafficNonFreeFlow {
    _reactEnableTrafficNonFreeFlow = reactEnableTrafficNonFreeFlow;
   self.nonFreeFlowTrafficEnabled = _reactEnableTrafficNonFreeFlow;
}

-(void)setReactEnableTrafficClosure:(BOOL)reactEnableTrafficClosure{
    _reactEnableTrafficClosure = reactEnableTrafficClosure;
    self.closureTrafficEnabled = _reactEnableTrafficClosure;
}

-(void)setReactEnableTrafficFreeFlow:(BOOL)reactEnableTrafficFreeFlow {
    _reactEnableTrafficFreeFlow = reactEnableTrafficFreeFlow;
    self.freeFlowTrafficEnabled = _reactEnableTrafficFreeFlow;
}
...
- (void)setReactAnchorRotateOrZoomGesturesToCenter:(BOOL)reactAnchorRotateOrZoomGesturesToCenter
{
    _reactAnchorRotateOrZoomGesturesToCenter = reactAnchorRotateOrZoomGesturesToCenter;
    self.anchorRotateOrZoomGesturesToCenterCoordinate = _reactAnchorRotateOrZoomGesturesToCenter;
}
...
-(void)setReactEnableGeoAnalyticsInfoWindow:(BOOL)reactEnableGeoAnalyticsInfoWindow {
    _reactEnableGeoAnalyticsInfoWindow = reactEnableGeoAnalyticsInfoWindow;
}

-(void)setReactLogoClickEnabled:(BOOL)reactLogoClickEnabled {
    _reactLogoClickEnabled = reactLogoClickEnabled;
    self.logoClickEnabled = _reactLogoClickEnabled;
}
...
- (void)setReactMapplsStyle:(NSString *)reactMapplsStyle {
    _reactMapplsStyle = reactMapplsStyle;
    if(_reactMapplsStyle != nil) {
        [self _removeAllSourcesFromMap];
        [self setMapplsMapStyle:_reactMapplsStyle];
    }
}

- (void)setReactFloor:(NSInteger)reactFloor {
    _reactFloor = reactFloor;
    [_indoorPlugin mapView:self switchToFloor: reactFloor];
}
