...
- (void)setReactMapplsPin:(NSString *)reactMapplsPin
{
    _reactMapplsPin = reactMapplsPin;
    [self updateMapplsPin:reactMapplsPin completionHandler:^(BOOL isSuccess, NSString * _Nullable errorMessage) {
...
{
    for(MGLAnnotationView *annotation in _map.selectedAnnotations) {
        [_map deselectAnnotation: annotation animated:NO];
    }
...
- (void)_addAnnotation
{
    ...
    MapplsMapView *mmiMapView = _map;
        [mmiMapView addMapplsAnnotation: self completionHandler:nil];
