...
Sets the maximum number of Mappls-hosted tiles that may be downloaded and stored on the current device.<br/>The Mappls Terms of Service prohibit changing or bypassing this limit without permission from Mappls.
