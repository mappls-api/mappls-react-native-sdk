...
const MapplsGLSnapshotManger = NativeModules.MGLSnapshotModule;
...
class SnapshotManager {
   ...
   * const uri = await MapplsGL.snapshotManager.takeSnap({
  ...
  async takeSnap(options = {}) {
    ...
    const uri = await MapplsGLSnapshotManger.takeSnap(snapshotOptions);
    return uri;
  }
}
