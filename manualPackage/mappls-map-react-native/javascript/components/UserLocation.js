...
export const normalIcon = (showsUserHeadingIndicator, heading) => [
  <CircleLayer
    key="mapplsUserLocationPluseCircle"
    id="mapplsUserLocationPluseCircle"
    style={layerStyles.normal.pluse}
  />,
  <CircleLayer
    key="mapplsUserLocationWhiteCircle"
    id="mapplsUserLocationWhiteCircle"
    style={layerStyles.normal.background}
  />,
  <CircleLayer
    key="mapplsUserLocationBlueCicle"
    id="mapplsUserLocationBlueCicle"
    aboveLayerID="mapplsUserLocationWhiteCircle"
