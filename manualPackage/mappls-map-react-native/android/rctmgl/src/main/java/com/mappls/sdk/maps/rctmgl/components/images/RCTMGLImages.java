...
public class RCTMGLImages extends AbstractMapFeature {
    ...
    public boolean addMissingImageToStyle(@NonNull String id, @NonNull MapplsMap map) {
    ...
    public void addImagesToStyle(Map<String, ImageEntry> images, @NonNull MapplsMap map) {
        if (images != null) {
            addRemoteImages(new ArrayList<>(images.entrySet()), map);
        }
    }

    public void addNativeImagesToStyle(Map<String, BitmapDrawable> images, @NonNull MapplsMap map) {
        if (images != null) {
            addNativeImages(new ArrayList<>(images.entrySet()), map);
        }
    }

    public void sendImageMissingEvent(@NonNull String id, @NonNull MapplsMap map) {
        if (mSendMissingImageEvents) {
            mManager.handleEvent(ImageMissingEvent.makeImageMissingEvent(this, id));
        }
    }

    private boolean hasImage(String imageId, @NonNull MapplsMap map) {
    ...
    private void addNativeImages(@Nullable List<Map.Entry<String, BitmapDrawable>> imageEntries, @NonNull MapplsMap map) {
        Style style = map.getStyle();
    ...
    private void addRemoteImages(@Nullable List<Map.Entry<String, ImageEntry>> imageEntries, @NonNull MapplsMap map) {
        Style style = map.getStyle();
        if (style == null || imageEntries == null) return;
