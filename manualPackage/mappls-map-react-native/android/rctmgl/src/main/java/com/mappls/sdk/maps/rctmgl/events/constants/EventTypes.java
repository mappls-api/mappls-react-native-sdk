...
public class EventTypes {
    ...
    public static final String WILL_REINIT_MAP = "onmapreinit";
    public static final String DID_LOADED_MAPPLS_MAP_STYLES = "didloadedmapplsmapsstyles";
    ...
    //Indoor Event Types
    public static final String HIDE_INDOOR_CONTROL = "hideindoorcontrol";
    public static final String SHOW_INDOOR_CONTROL = "showindoorcontrol";

    //geoAnalytics Events
    public static final String GEO_ANALYTICS_LAYER_PRESS = "geoanalyticspressed";
