package com.mappls.sdk.maps.rctmgl.events.constants;
...
public class EventKeys {
    ...
    public static final String MAP_REINIT = ns("map.reinit");
    public static final String MAP_CLICK = ns("map.press");
    public static final String MAP_PLACE_CLICK = ns("map.placeclick");
    public static final String MAP_LONG_CLICK = ns("map.longpress");
    public static final String MAP_ONCHANGE = ns("map.change");
    public static final String MAP_STYLE_LOADED = ns("map.mapplsstyleload");
    ...
    //Indoor Events
    public static final String HIDE_INDOOR_CONTROL = ns("indoor.hidecontrol");
    public static final String SHOW_INDOOR_CONTROL = ns("indoor.showcontrol");

    //geoAnalytics Events
    public static final String GEO_ANALYTICS_LAYER_PRESS = ns("geo.analytics.pressed");
