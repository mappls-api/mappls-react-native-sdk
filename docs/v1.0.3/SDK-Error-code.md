...
* AUTHENTICATION_FAILED (6): This error occurs when the map fails to authenticate itself with the Mappls server due to incorrect keys.
* SDK_INITIALISATION_FAILED (7): This error occurs when the SDK initialization fails.
