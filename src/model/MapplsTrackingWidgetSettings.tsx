...
export class MapplsTrackingWidgetSetting{
  latentViz: "jump" | "route" | "fly" | undefined = "jump";
  ...
  lastRiderLocation: number[] | undefined = undefined; 

    static instance = new MapplsTrackingWidgetSetting()
}